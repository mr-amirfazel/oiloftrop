  ...
  const repeatedMarqueeContent = React.useMemo(() => {
    return Array.from({ length: 4 }).map((_, idx) => (
      <React.Fragment key={idx}>
        <span className="text-[#060010] uppercase font-normal text-[2vh] leading-[1.2] p-[1vh_1vw_0]">{text}</span>
        <div
          className="w-60 h-60 my-[2em] mx-[2vw] p-[1em_0] rounded-full bg-cover bg-center"
